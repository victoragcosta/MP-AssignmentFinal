...
static const char qt_meta_stringdata_ProductWidget[] = {
    "ProductWidget\0\0on_visualizar_clicked()\0"
};
...
void ProductWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_visualizar_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData ProductWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProductWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ProductWidget,
      qt_meta_data_ProductWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ProductWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProductWidget))
